    ...
    return (
        <div>
            <div className="pt-24 mb-10">
                <h2 className="text-center text-6xl text-[#45ccbe]">Contact US</h2>
            </div>
            <div className="container mx-auto bg-gray-50 mb-10">
                <div className="p-12">
                    <div className="grid md:grid-cols-3 gap-10">
                        <div className="border bg-white p-5">
                            <h2 className="text2xl font-bold text-[#2d8e84]">
                                General Information
                            </h2>
                        ...
                        <div className="border bg-white p-5">
                            <h2 className="text2xl font-bold text-[#2d8e84]">Working Hours</h2>
            ...
            <h2 className="text-center text-6xl text-[#45ccbe]">Google Map</h2>
