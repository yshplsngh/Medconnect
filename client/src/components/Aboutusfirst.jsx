            ...
            <div className="container w-10/12 mx-auto">
                <div className="md:flex items-center">
                    ...
                    <div className="md:w-1/2 md:px-16">
                        <h2 className="text-2xl md:text-4xl pt-4 text-[#45ccbe] font-bold">
                            Clinic with Innovative Approach to Treatment
                        </h2>
                        <p className="py-4 text-base text-justify md:text-base">
                        ...
                        <h3 className="text-[#45ccbe] text-xl font-semibold">
