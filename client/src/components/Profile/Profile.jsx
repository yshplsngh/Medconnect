        ...
        <div className="p-16">
          <div className="p-8 bg-white shadow mt-24">
            ...
            <div className="mt-20 text-center border-b pb-12">
              <h1 className="text-4xl font-medium text-gray-700">Govind Upadhyay, <span className="font-light text-gray-500">20</span></h1>
              <p className="font-light text-gray-600 mt-3">GLA UNIVERSITY,MATHURA</p>
              <p className="mt-8 text-gray-900 font-bold text-xl">1 Appointment Scheduled</p>
<p className="mt-2 text-gray-800">Dr Surya Pratap</p>
